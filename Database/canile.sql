...
(9, 'Jamal', 'Cavalier king charles spaniel', 2, 'F', 1, 'Parvovirus canino, Cimurro canino, Epatite, Leptospirosi, Rabbia, Bordetella, Influenza canina', 1, 'Vivace e ribelle. Ha completamente perso la vista all\'occhio sinistro in seguito a un incidente', '2022-09-17'),
...
(18, 'Laika', 'Kooikerhondje', 5, 'F', 1, 'Parvovirus canino, Cimurro canino, Epatite, Leptospirosi, Rabbia, Bordetella, Influenza canina', 1, 'Ama il contatto umano e la compagnia di altri animali. Soffre di alcune intolleranze alimentari', '2019-08-22'),
...
(21, 'Skipper', 'Meticcio', 4, 'F', 1, 'Parvovirus canino, Cimurro canino, Epatite, Leptospirosi, Rabbia, Bordetella, Influenza canina, Leishmania', 1, 'Timida e paurosa con le persone, ha bisogno di affetto per rilassarsi', '2020-01-02'),
(22, 'Hope', 'Meticcio', 6, 'F', 1, 'Parvovirus canino, Cimurro canino, Epatite, Leptospirosi, Rabbia, Influenza canina, Vaccino di Lyme', 1, 'Hope ha un carattere strepitoso nonostante la vita non le abbia riservato un bel trattamento. All\'inizio dell\'anno, mentre girovagava abbandonata per le campagne, ha subito un brutto incidente a causa del quale ha perso l\'occhio destro.', '2018-10-05'),
(23, 'Troy', 'Dogo argentino', 5, 'M', 0, 'Parvovirus canino, Cimurro canino, Epatite, Leptospirosi, Rabbia, Bordetella, Influenza canina, Vaccino di Lyme, Leishmania', 1, 'Per lui cerchiamo un\'adozione consapevole e molto ponderata da parte di persone esperte nel trattare questa tipologia di cani', '2022-08-24');
